'''
    ...
    @该文件仅支持OVIS
    python SubmitResOVIS.py --descriptionname 5024999 --filepathname /ourdisk/spaceB/liudun/project_code/VNext/outdir/IDOL_OVIS_R50_cocoimagenet_noboxinstloss/inference/results.zip
'''
...
def get_papers():
    ...
    headers = {
        ...
        'Cookie': 'csrftoken=Ihl7XhEDQd1ssPqsMrNRAN7h7UE6QX8oUbYDq9OarSVxRbKZ8kJUFb3mlzbqjdcq; sessionid=r66jn04t32lu6oiraxduhckd6hgdtcyc',
...
def submission(id,description_name="123333333444555566"):
    url = 'https://codalab.lisn.upsaclay.fr/api/competition/4763/submission'
    headers = {
        'accept': '*/*',
        'Accept-Encoding': 'gzip, deflate, br',
        'accept-language': 'zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6',
    ...
    params = {
        ...
        'docker_image': None,
        'method_name': "myczld",
        'method_description': description_name,
        'project_url': None,
