...
"""
    ...
    if dataset_name=="ytvis_2019_train":    
        dataset_dicts = load_variavle("/ourdisk/spaceB/liudun/project_code/VNext/idol_cocoimageNet_inferenceData/IDOL_COCOImageNet_R50_train_top5_thres00.txt")    
        logger.info("Done load IDOL_COCOImageNet_R50_train_top5_thres00")
        logger.info("Done loading {} samples.".format(len(dataset_dicts)))
...
if __name__ == "__main__":
    ...
    dicts = load_variavle("/share/home/liudun/VNext-main/ovis_datasets_dict_RLE_gt.txt")
    logger.info("Done loading {} samples.".format(len(dicts)))

    dirname = "/share/home/liudun/paperguides/VNext/demo_outdir/ovis_datasets_dict_RLE_gt-data-demo"
