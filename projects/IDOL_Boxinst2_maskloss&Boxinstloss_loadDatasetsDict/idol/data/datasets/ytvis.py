...
"""
    ...
    if dataset_name=="ytvis_ovis_train":    
        dataset_dicts = load_variavle("/share/home/liudun/VNext-main/ovis_datasets_dict_RLE_gt_Del_difference_delmaskIOUbelow06.txt")    
        logger.info("ytvis_ovis_train {} datasets have been loaded".format("/share/home/liudun/VNext-main/ovis_datasets_dict_RLE_gt_Del_difference_delmaskIOUbelow06.txt"))
