...
"""
    ...
    if dataset_name=="ytvis_2019_train":    
        dataset_dicts = load_variavle("/share/home/liudun/paperguides/VNext/pseudo_datasets_dict_RLE_IDOLBoxinstSwinLInferenceMask_gtBox_ytvis19_ii_delrepeat.txt")    
    ########################################################################################    
...
if __name__ == "__main__":
    ...
    dicts = load_variavle("/share/home/liudun/paperguides/VNext/pseudo_datasets_dict_RLE_IDOLBoxinstSwinLInferenceMask_gtBox_ytvis19_ii_delrepeat.txt")
    logger.info("Done loading {} samples.".format(len(dicts)))

    dirname = "/share/home/liudun/paperguides/VNext/demo_outdir/IDOL_boxinst2_SwinL_inferencemask_ytvis19-data-vis-ii"
    ...
    for d in dicts:
        ...
        logger.info("vid_name {} .".format(vid_name))
