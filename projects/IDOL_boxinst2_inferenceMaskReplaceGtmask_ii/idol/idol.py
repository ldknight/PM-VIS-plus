...
class IDOL(nn.Module):
    ...
    def forward(self, batched_inputs):
        ...
        if self.training: 
            ...
            save_variable(target_pseudo_item,"/share/home/liudun/paperguides/VNext/pseudo_datasets_dict_RLE_IDOLBoxinstSwinLInferenceMask_gtBox_ytvis19_ii/"+str(batched_inputs[0]['video_id'])+".txt")
                ...
                for index,item in enumerate(target_pseudo_item['annotations']):
                    ...
                    for instance_index,instance_item in enumerate(item):
                        ...
                        for instance_index2,instance_item2 in enumerate(item):
                            if instance_index!=instance_index2 and instance_item['id']==instance_item2['id'] and aa[instance_index2]==0:
