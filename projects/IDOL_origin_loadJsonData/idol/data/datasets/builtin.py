...
################################################
# einston =>update json path
_PREDEFINED_SPLITS_YTVIS_2019 = {
    "ytvis_2019_train": ("ytvis_2019/train/JPEGImages",
                         "/ourdisk/spaceB/liudun/project_code/VNext/outdir/IDOL_YTVIS19_r50_cocoAndImagenetdata_inferenceTrain/inference/results_Top1Score_VOS_trainType_top3Thres02NoOverlap.json"),
...
def register_all_ytvis_2019(root):
    for key, (image_root, json_file) in _PREDEFINED_SPLITS_YTVIS_2019.items():
        ...
        register_ytvis_instances(
            key,
            _get_ytvis_2019_instances_meta(),
            os.path.join(root, json_file) if "ytvis_2019_train"!=key else json_file,
