...
if __name__ == "__main__":
    ...
    dicts = load_variavle("/share/home/liudun/paperguides/VNext/pseudo_datasets_dict_RLE_IDOLBoxinstSwinLInferenceMask_gtBox_ytvis19.txt")
    logger.info("Done loading {} samples.".format(len(dicts)))

    dirname = "/share/home/liudun/paperguides/VNext/demo_outdir/IDOL_boxinst2_SwinL_inferencemask_ytvis19-data-vis"
