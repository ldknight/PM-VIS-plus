...
def add_idol_config(cfg):
    ...
    cfg.MODEL.Boxinst._warmup_iters = 10000
    cfg.MODEL.Boxinst.pairwise_color_thresh = 0.3

    cfg.MODEL.Boxinst.PAIRWIAE_DILATTION = 2
    cfg.MODEL.Boxinst.PAIRWISE_SIZE = 3

    # LOSS item
    cfg.MODEL.Losses = CN()
    cfg.MODEL.Losses.Boxinstloss=True
    cfg.MODEL.Losses.Maskloss=True
