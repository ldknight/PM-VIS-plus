...
if __name__ == "__main__":
    ...
    # json_file = "/share/home/liudun/VNext-main/datasets/ytvis_2021/annotations/instances_val_sub.json"
    # image_root = "/share/home/liudun/VNext-main/datasets/ytvis_2021/val/JPEGImages"
    # dicts = load_ytvis_json(json_file, image_root, dataset_name="ytvis_2021_val")
    # logger.info("Done loading {} samples.".format(len(dicts)))
    # save_variable(dicts,"/share/home/liudun/VNext-main/ytvis_2021_val.txt")
    ...
    dicts=load_variavle("/share/home/liudun/VNext-main/datasets_dict_RLE_gt_delmaskIOUover06.txt")
    logger.info("Done loading {} samples.".format(len(dicts)))

    # dirname = "ytvis-data-vis"
    dirname = "/ourdisk/spaceB/liudun/project_code/VNext-main/demo_outdir/ytvis19-data-vis-datasets_dict_RLE_gt_delmaskIOUover06"
