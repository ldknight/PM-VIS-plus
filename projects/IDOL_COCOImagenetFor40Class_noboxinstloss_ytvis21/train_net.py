...
def filter_imagenet(dataset_dict):
    ImageNet_TO_YTVIS_2021 = {#19个
        1:8, 2:10, 3:11, 4:13, 5:15, 6:16, 7:17, 8:20, 9:21, 10:22, 11:24, 12:25, 13:27, 14:28, 15:30, 16:32, 17:35, 18:38, 19:39 
    }
    ...
    for frame in dataset_dict:
        ...
        for anno_item in annotations:
            ...
            ytvis19_cateid=[v for k,v in ImageNet_TO_YTVIS_2021.items() if k==imagenet_cateid][0]
...
def filter_cocofake(dataset_dict):
    COCO_TO_YTVIS_2021 = {#23个#全是真实id，即 1-person
    ...
    cocofake_cateIds=[key for key,val in COCO_TO_YTVIS_2021.items()]
    ...
    for frame in dataset_dict:
        ...
        for anno_item in annotations:
            ...
            ytvis19_cateid=[v for k,v in COCO_TO_YTVIS_2021.items() if k==coco_cateid][0]
            anno_item['category_id']=ytvis19_cateid-1   #保证类别是0--39
        frame['annotations'] = annotations
    return dataset_dict
