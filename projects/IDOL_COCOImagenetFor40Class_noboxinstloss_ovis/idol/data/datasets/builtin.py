...
_PREDEFINED_SPLITS_ImageNet = {
    "imagenet_train_fake": ("imagenet/images_ovis", "imagenet/annotations/imagenet21k2ovis_train.json"),
}
...
_PREDEFINED_SPLITS_COCOFake = {
    "coco_train_fake": ("coco/train2017", "coco/annotations/coco2ovis_train.json"),
}
