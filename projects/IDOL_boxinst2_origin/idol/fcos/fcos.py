...
############################################################
from ..layers import DFConv2d, NaiveGroupNorm
...
class FCOS(nn.Module):
    ...
    def __init__(self, cfg, input_shape: Dict[str, ShapeSpec]):
        ...
        self.yield_box_feats = cfg.MODEL.FCOS.YIELD_BOX_FEATURES #false
    ...
    def forward(self, images, features, gt_instances=None, top_module=None):
        ...
        # features = [features[f] for f in self.in_features]
        ############################################################
        tensorone,_ = features[-1].decompose()
        features = [tensorone]
        ############################################################
