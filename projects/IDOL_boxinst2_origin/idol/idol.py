...
class IDOL(nn.Module):
    ...
    #     locations = []
    #     for level, feature in enumerate(features[1:]):
    #         feature,_=feature.decompose()
    #         h, w = feature.size()[-2:]
    #         locations_per_level = compute_locations(
    #             h, w, self.backbone.strides[level],
    #             feature.device
    #         )
    ...
    #     soi = []
    #     prev_size = -1
    #     for s in [64, 128, 256, 512]:   #[16,32,64]
    ...
    #         loc_to_size_range_per_level = loc_per_level.new_tensor(sizes_of_interest[l])
    ...
    #         is_in_boxes = self.get_sample_region(
    #             bboxes, [16,32,64], num_loc_list, xs, ys,
    #             bitmasks=bitmasks, radius=1.5
    #         )
