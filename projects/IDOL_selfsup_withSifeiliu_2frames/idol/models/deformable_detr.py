...
class SetCriterion(nn.Module):
    ...
    def __init__(self, num_classes, matcher, weight_dict, losses, focal_alpha=0.25, mask_out_stride=4, num_frames=1):
        ...
        self.num_frames = num_frames
        ################################################
        # 存储 video_embedding 以
        # self.all_video_embedding_list={}  #{video_id:['img_name',tensor]}
        self.basepath = "/share/home/liudun/VNext-main/projects/IDOL/video_embedding"
    ...
    def forward(self, outputs, targets, ref_target, indices_list):
        ...
        return losses
def insert_item_to_json(a,key,val):
    indexx=0
    for item in a:
        indexx+=1
        if int(item)>5:
